...
const CHANGELOG_DATA: ReleaseItem[] = [
  {
    ...
    date: '2026.08.20',
    isLatest: true,
    title: '外层背景卡片置景 & 全新色卡胶囊 UI/UX',
    highlights: [
      {
        icon: '🖼️',
        label: '外层背景卡片与立体阴影',
        desc: '支持将邮票/票根一键置入复古背景卡片中（暖黄纸、极夜黑、森林绿、灰蓝、落日橙、陶土红、柔雾粉、燕麦米等），自带真实立体柔光投影，小红书配图直出即用。',
      },
      {
        icon: '🎨',
        label: '色卡胶囊选择器 UI/UX',
        desc: '全面重构色彩选择器为贴纸风色卡胶囊，支持透明无底与多款复古配色一键滑动切换，触控与视觉质感倍增。',
      },
      {
        icon: '🧭',
        label: '工作台布局与重选优化',
        desc: '定制页顶部新增「🏠 首页选图」快捷按钮，支持随时清空重选；导航栏强制单行排版，彻底解决折行拥挤问题。',
      },
      {
        icon: '📜',
        label: '版本更新日志组件上线',
        desc: '内置版本更新演进记录与哲学名言开场，随时查阅功能新特性。',
      },
    ],
  },
  {
